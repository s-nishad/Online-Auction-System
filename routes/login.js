    ...
    (async ()=>{
        try {
            ...
            if(errors.length !== 0){
                ...
                await Users.create({fullname: req.body.fullname, email: req.body.email, address: req.body.address, phone: req.body.phone, password: hashPassword, status: req.body.status});
